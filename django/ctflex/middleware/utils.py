"""Define information (copied from django-request)"""
...
from ctflex.middleware.router import patterns
...
browsers = patterns(
    ...
    (
    r'Mozilla/(?P<mozilla_version>[-.\w]+) \(compatible; DotBot/(?P<version>[-.\w]+); http://www.dotnetdotcom.org/, crawler@dotnetdotcom.org\)',
    'Dotbot'),
