...
from ctflex.management.commands.helpers import add_debug_argument
from ctflex.models import Announcement, Competitor, CtfProblem

class Command(BaseCommand):
    help = "Make an announcement. See docs for complete announcement spec."
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            if Announcement.objects.filter(pk=data['id']):
                pre_existing = True
